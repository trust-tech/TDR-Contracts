...
import './interfaces/ITdrQuickConverter.sol';
import './interfaces/IEtherToken.sol';
import './interfaces/ISmartToken.sol';
import './interfaces/ITokenConverter.sol';

/*
    The TdrQuickConverter contract provides allows converting between any token in the 
    tdr network in a single transaction.

    A note on conversion paths -
    Conversion path is a data structure that's used when converting a token to another token in the tdr network
...
*/
contract TdrQuickConverter is ITdrQuickConverter, TokenHolder {
    mapping (address => bool) public etherTokens;   // list of all supported ether tokens

    /**
        @dev constructor
    */
    function TdrQuickConverter() {
    }
    ...
    */
    ...
    /**
        @dev converts the token to any other token in the tdr network by following
    ...
    */
    ...
    /**
        @dev claims the caller's tokens, converts them to any other token in the tdr network
