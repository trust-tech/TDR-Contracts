...
/*
    ...
    The Tdr version of the token converter, allows conversion between a smart token and other ERC20 tokens and between different ERC20 tokens and themselves.
...
*/
contract TdrConverter is ITokenConverter, SmartTokenController, Managed {
    ...
    string public converterType = "tdr";

    ITdrConverterExtensions public extensions;       // tdr converter extensions contract
    ...
    /**
        ...
        @param  _extensions         address of a tdr converter extensions contract
        @param  _maxConversionFee   maximum conversion fee, represented in ppm
        @param  _connectorToken     optional, initial connector, allows defining the first connector at deployment time
        @param  _connectorWeight    optional, weight for the initial connector
    */
    function TdrConverter(ISmartToken _token, ITdrConverterExtensions _extensions, uint32 _maxConversionFee, IERC20Token _connectorToken, uint32 _connectorWeight)
    ...
    */
    ...
    /*
        ...
        @param _extensions    address of a tdr converter extensions contract
    */
    function setExtensions(ITdrConverterExtensions _extensions)
        public
        ownerOnly
        validAddress(_extensions)
        notThis(_extensions)
    ...
    /*
        ...
        @param _path    new quick buy path, see conversion path format in the TdrQuickConverter contract
    */
    ...
    */
    ...
    /**
        @dev converts the token to any other token in the tdr network by following a predefined conversion path
        note that when converting from an ERC20 token (as opposed to a smart token), allowance must be set beforehand

        @param _path        conversion path, see conversion path format in the TdrQuickConverter contract
    ...
    */
        ...
        returns (uint256)
    {
        ...
        ITdrQuickConverter quickConverter = extensions.quickConverter();
