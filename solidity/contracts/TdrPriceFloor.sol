...
/*
    ...
    The tdr price floor contract is a simple contract that allows selling smart tokens for a constant ETH price

    'Owned' is specified here for readability reasons
*/
contract TdrPriceFloor is Owned, TokenHolder {
    ...
    */
    function TdrPriceFloor(ISmartToken _token)
        validAddress(_token)
    {
        token = _token;
    }
